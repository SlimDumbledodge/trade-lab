...
export default function TradeExecutionForm() {
    ...
    const { data: portfolio, isLoading: isPortfolioLoading, error: portfolioError } = usePortfolio(session?.accessToken)
        ...
        <div className="w-[260px]">
            <Tabs value={transactionType} onValueChange={(value) => setTransactionType(value as TransactionType)}>
                <TabsList className="w-full">
                    ...
                    <TabsTrigger value={TransactionType.SELL} disabled={!portfolioAsset} className="flex-1">
                        Vendre
                    </TabsTrigger>
                </TabsList>
